...
export function buildGeneratePrompt(input: PromptInput) {
  ...
  return [
    ...
    "Formato de saida:",
    "- Use Markdown.",
    "- Não reproduza o cabeçalho institucional informado na resposta; o sistema já adiciona brasão, cabeçalho e identificação do órgão.",
    `- Use como titulo principal apenas uma vez: ${definition.name}.`,
