    ...
    <main className="min-h-screen bg-paper text-ink">
      ...
      <header className="border-b border-line bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-5 sm:px-6">
          <Link href="/login" className="font-serif text-xl font-semibold">
      ...
      <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:py-20">
        ...
        <h1 className="mt-4 max-w-3xl font-serif text-5xl font-semibold leading-tight">
          Biblioteca de Modelos de Documentos Públicos Editáveis
        </h1>
        ...
        <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {modelPages.map((page) => (
            ...
            >
              <div>
                <p className="font-mono text-[11px] uppercase tracking-[0.14em] text-muted">Modelo editável</p>
